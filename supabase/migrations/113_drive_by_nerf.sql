...
COMMENT ON FUNCTION perform_pvp_attack IS 'PvP attack with Drive-By nerf: no respect steal, max 2 crew killed. Shield blocks PvP, flat respect loss on defeat (-4 to -8)';
