-- =====================================================
-- FIX: Offline Summary Column Name + Notification Types
-- =====================================================

-- Fix notification type constraint to allow 'reward' type
ALTER TABLE public.notifications DROP CONSTRAINT IF EXISTS notifications_type_check;
ALTER TABLE public.notifications ADD CONSTRAINT notifications_type_check 
    CHECK (type IN ('attack', 'income', 'job', 'family', 'system', 'bounty', 'reward'));

-- Fix column name: last_collected_at -> last_collected
...
BEGIN
    ...
    -- Fixed: use last_collected instead of last_collected_at
    SELECT COALESCE(SUM(
        CASE 
