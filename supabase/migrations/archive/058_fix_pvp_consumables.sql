-- =====================================================
-- FIX PVP ATTACK SYSTEM: CONSUMABLES + BANK COLUMN
-- =====================================================
-- 1. Set requires_consumables = true for applicable attack types
-- 2. Fix column reference from 'bank' to 'banked_cash'

-- =====================================================
-- 1. UPDATE ATTACK TYPES TO REQUIRE CONSUMABLES
-- =====================================================

UPDATE public.pvp_attack_types 
SET requires_consumables = true
WHERE id IN ('safe_heist', 'drive_by');

-- =====================================================
-- 2. FIX PERFORM_PVP_ATTACK RPC (bank -> banked_cash)
-- =====================================================
...
-- =====================================================
-- 3. UPDATE GET_PVP_ATTACK_TYPES TO INCLUDE CONSUMABLES
-- =====================================================
...
-- Add comments
COMMENT ON FUNCTION perform_pvp_attack IS 'PvP attack with consumable requirements and proper bank column reference';
