-- =====================================================
-- COLLECT BUSINESS INCOME RPC WITH COOLDOWN ENFORCEMENT
-- =====================================================
-- Fixes the bug where players could collect income repeatedly
-- without waiting for cooldown, allowing unlimited money generation.
