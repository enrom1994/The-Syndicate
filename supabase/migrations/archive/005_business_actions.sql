...
BEGIN
    ...
    VALUES (player_id_input, -business_cost, 'cash', 'business_purchase', 'Bought business: ' || business_id_input);
...
BEGIN
    ...
    -- Log transaction
    INSERT INTO transactions (player_id, amount, currency, transaction_type, description)
    VALUES (player_id_input, -upgrade_cost, 'cash', 'business_upgrade', 'Upgraded business to level ' || (business_record.level + 1)::TEXT);
