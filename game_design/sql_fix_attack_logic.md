# Secure the Attack System

Now that we fixed the crash, let's make the fighting meaningful!
We are moving the "Fight Logic" to the server. This prevents cheating and properly includes **Item Bonuses** and **Crew Bonuses** in the fight calculation.
